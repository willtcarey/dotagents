...
Format your response as human-readable markdown using the structure below.
...
(If applicable, include a ```suggestion block with the fix)
...
* The file/line reference should overlap with the diff.
